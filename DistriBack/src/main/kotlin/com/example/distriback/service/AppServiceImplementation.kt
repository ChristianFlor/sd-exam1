...
class AppServiceImplementation(val fileRepo: FileRepo) : AppServiceInterface{
    ...
    override fun uploadFile(file: MultipartFile): List<Filex>? {
        var storageConnectionAzure = "DefaultEndpointsProtocol=https;AccountName=bucketmidterm1parcial;AccountKey=bpE/UAdlHj/LiQgjV2HEeGrhuydIxD/dbh0TalvQ8UpKBcoblfIaJJ8iU6MKWV+uOBluMjM+631q+AStYKPSlg==;EndpointSuffix=core.windows.net"
